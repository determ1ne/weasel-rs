...
fn main() {
    ...
    windows_bindgen::builder()
        ...
        .filters([
            ...
            "Windows.Win32.ITfReadOnlyProperty",
            "Windows.Win32.ITfInputScope",
            ...
            "Windows.Win32.UI.TextServices.GUID_PROP_INPUTSCOPE",
            "Windows.Win32.IS_PASSWORD",
            "Windows.Win32.IS_NUMERIC_PASSWORD",
            "Windows.Win32.TF_TMF_SECUREMODE",
...
fn embed_icons() {
    ...
    let definitions: Vec<String> = [
        ...
        ("KEY_ALERT_DARK_PATH", "key-alert-dark.ico"),
        ("KEY_ALERT_LIGHT_PATH", "key-alert-light.ico"),
        ("KEY_DARK_PATH", "key-dark.ico"),
        ("KEY_LIGHT_PATH", "key-light.ico"),
